            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <x-dropdown align="right" width="56">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('organization.edit')" wire:navigate class="flex items-center gap-3">
                            <svg class="w-4 h-4 text-slate-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                        ...
                        <x-dropdown-link :href="route('activity-logs.index')" wire:navigate class="flex items-center gap-3">
                            <svg class="w-4 h-4 text-slate-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t border-slate-200">
        ...
        <div class="pt-4 pb-1 border-t border-slate-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('organization.edit')" :active="request()->routeIs('organization.*')" wire:navigate>
                    {{ __('Οργανισμός') }}
                </x-responsive-nav-link>
                @endif
