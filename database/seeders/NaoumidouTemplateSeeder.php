...
class NaoumidouTemplateSeeder extends Seeder
{
...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .about { font-size: 12px; margin: 0 0 6mm; }
    .subject {
    ...
    .dates {
        font-size: 21px; font-weight: 500; margin: 0 0 7mm; color: #0f172a;
    }
    .dates .dash { padding: 0 8px; font-weight: 700; }

    .qr { margin: 2mm auto 4mm; }
...
HTML;
        ...
        CertificateCategory::where('slug', 'naoumidou')->update(['html_template' => $html]);

        $this->command->info('Naoumidou template saved.');
    }
}
